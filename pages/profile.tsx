            ...
            <div className={'max-w-[650px] w-full'}>
                <div className={'flex flex-col items-center w-full bg-white rounded-[16px]'}>
                    <div className={'relative w-full h-[230px] rounded-[16px] bg-dark-gradient'}>
                        ...
                        <span className={'text-[44px] leading-[44px] text-whitenew-100 absolute left-[45px] bottom-[40px] max-w-[300px]'}>Your profile settings</span>
                    </div>
                    <div className={'flex flex-col w-full px-[80px] py-[56px]'}>
                        ...
                        <PrimaryButton label={'SAVE'} className={'mt-10 max-w-[220px]'} onClick={() => showToast('PROFILE CHANGES SUCCESSFULLY SAVED')} />
                    </div>
                </div>
            </div>
        </div>
