                ...
                <div className={'flex flex-col items-center w-full'}>
                    ...
                    <div className={'w-full flex flex-col space-y-6 bg-white rounded-[16px] p-12 mt-5'}>
                        <div className={'flex flex-col space-y-2'}>
                            ...
                            <div className={'relative flex items-center'}>
                                ...
                                <div className={'absolute right-4 flex items-center space-x-[10px]'}>
                                    <span className={'bg-grey-20 flex items-center justify-center px-3 h-[28px] w-[140px] rounded-[6px] text-[12px] leading-[12px]'} onClick={() => setLots(1)}>MIN</span>
                                    <span className={'bg-grey-20 flex items-center justify-center px-3 h-[28px] w-[140px] rounded-[6px] text-[12px] leading-[12px]'} onClick={() => setLots(maxBalance)}>MAX</span>
                                </div>
                            </div>
                        </div>
                        <div className={'flex flex-col space-y-2'}>
                        ...
                        <div className={'flex items-center space-x-6'}>
                            ...
                            <PrimaryButton label={'LIST NFT'} disabled={!signer || !product || txPending} loading={txPending} className={'flex items-center justify-center'} onClick={onListNFT} />
                        </div>
                    </div>
                </div>
            </div>
