...
export default function Product({ product }: { product: IProduct }) {
  return (
    <div className="flex flex-col max-w-sm p-6 bg-gray-100 border border-gray-200 rounded shadow-md dark:bg-gray-800 dark:border-gray-700 hover:border-gray-300">
      <div>
        <span className='inline-block text-sm bg-gray-200 p-2'>{status[product.status]}</span>
      ...
      <div className='my-5 flex flex-row'>
        ...
        <div className='ml-3'>
          <h5 className="text-xl tracking-tight text-gray-900 dark:text-white">{product.underlying}</h5>
      ...
      <div className="flex justify-between my-1">
        ...
        <span className="text-sm dark:text-white">USDC {product.currentCapacity.toString()}</span>
      </div>
      ...
      <div className="flex justify-between mb-2">
        ...
        <span className="text-sm dark:text-white">USDC {product.maxCapacity.toString()}</span>
      </div>
      <div className='my-3'>
