...
export const PrimaryButton = ({ label, disabled = false, loading = false, className, onClick }: { label: string, disabled?: boolean, loading?: boolean, className?: string, onClick?: () => void }) => {
    return (
