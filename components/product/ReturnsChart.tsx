...
export const ReturnsChart = ({ tr1, tr2, strikePrice1, strikePrice2, strikePrice3 }: {
    tr1: number, tr2: number, strikePrice1: number, strikePrice2: number, strikePrice3: number
}) => {
    return (
        <div className={'mt-5'}>
            <Line
                data={{
                    labels: strikePrice3 > 0 ?
