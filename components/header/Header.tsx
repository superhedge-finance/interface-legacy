...
const Header = () => {
    ...
    return (
        <header className={'bg-[#F7F7F7] relative'}>
            ...
            { toast && (
                <div className={'absolute top-[78px] left-0 w-full h-[64px] flex items-center justify-center uppercase text-whitenew-100 bg-success rounded-br-[16px] rounded-bl-[16px] z-50'}>
                    {toast}
                </div>
            )}
        </header>
